"""
Búsqueda amplia de hiperparámetros XGBoost por asignatura de S2,
usando solo features de S1.  Entrena 2019-2022, testea 2023.
Threshold se elige por F1 sobre un split interno de validación (20%).
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Busqueda amplia de hiperparametros XGBoost S1->S2.")
...
def main() -> None:
    args = parse_args()
    print("=== Tuning S1 -> S2: Busqueda amplia ===")
    ...
    all_path = RESULTS_DIR / "tuning_temporal_s2_todos.csv"
    best_val_path = RESULTS_DIR / "tuning_temporal_s2_mejores_validacion.csv"
    best_oot_path = RESULTS_DIR / "tuning_temporal_s2_mejores_oot.csv"
