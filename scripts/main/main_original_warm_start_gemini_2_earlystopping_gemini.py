...
class Experiment:
    ...
    def train_and_eval(self, init_embeddings_path=None, init_vocab_path=None):
        ...
        print(f"\n⏱️ Tiempo total de entrenamiento: {total_training_time:.2f} segundos")

        # Guardar métricas y embeddings
        ...
        # Guardar el tiempo total en un archivo aparte y en el csv de métricas
        metrics_df = pd.DataFrame(self.history)
        metrics_df['total_training_time_sec'] = total_training_time
