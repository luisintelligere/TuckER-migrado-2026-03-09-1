...
class Experiment:
    # (El constructor y los métodos no cambian)
    def __init__(self, learning_rate=0.0005, ent_vec_dim=200, rel_vec_dim=200,
        ...
        self.history = []
        self.embeddings_history = []  # <--- MODIFICACIÓN 1: Inicializar lista para el historial de embeddings
    ...
    def evaluate(self, model, data):
        ...
        if not test_data_idxs: return {'hits@10': np.nan, 'hits@3': np.nan, 'hits@1': np.nan, 'mr': np.nan, 'mrr': np.nan}
    ...
    def train_and_eval(self, init_embeddings_path=None, init_vocab_path=None):
            ...
            for it in range(1, self.num_iterations + 1):
                ...
                model.eval()
                with torch.no_grad():
                    # Guardar snapshot de embeddings
                    emb_snapshot = {}
            ...
            print("\nEntrenamiento finalizado. Guardando el modelo y los historiales...")
...
if __name__ == '__main__':
    ...
    # ... (argumentos anteriores)
        # --- INICIO DE LA CORRECCIÓN: Añadir todos los argumentos que faltaban ---
    ...
    parser.add_argument("--init_embeddings", type=str, default=None,
                        help="Ruta al archivo .npy de embeddings iniciales.")
    parser.add_argument("--init_vocab", type=str, default=None,
                        help="Ruta al archivo .json del vocabulario de los embeddings iniciales.")
    ...
    # --- CORRECCIÓN EN LA LLAMADA A LA FUNCIÓN ---
