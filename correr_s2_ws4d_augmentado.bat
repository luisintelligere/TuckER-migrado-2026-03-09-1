:: ================================================================
:: ENTRENAMIENTO TUCKER S1->S2 WARM START 4D
:: Dataset aumentado: 2021 completo + reprueba de 2019/2020 (rdim 1-12)
:: ================================================================
...
set DATASET=dataset_augmentado_1920reprueba_2021_s2
...
ECHO ===============================================================
ECHO TODOS LOS ENTRENAMIENTOS AUGMENTADO FINALIZADOS.
ECHO ===============================================================
