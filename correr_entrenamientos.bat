...
python main.py --dataset 20121_multirelacional --output_prefix 20121_wn18 --num_iterations 500 --batch_size 128 --lr 0.005 --dr 0.995 --edim 200 --rdim 30 --input_dropout 0.2 --hidden_dropout1 0.1 --hidden_dropout2 0.2 --label_smoothing 0.1

:: --- Entrenamiento para el semestre 20122 ---
ECHO.
ECHO Entrenando con los datos de 20122...
python main.py --dataset 20122_multirelacional --output_prefix 20122_wn18 --num_iterations 500 --batch_size 128 --lr 0.005 --dr 0.995 --edim 200 --rdim 30 --input_dropout 0.2 --hidden_dropout1 0.1 --hidden_dropout2 0.2 --label_smoothing 0.1
